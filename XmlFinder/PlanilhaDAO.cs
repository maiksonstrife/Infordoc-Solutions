...
namespace XmlFinder
{
    public class PlanilhaDAO
    {
        ...
        public static void Insert(Planilha planilha)
        {
            ...
            DBConnection.ExecuteQueries(_sqlcommand, new SqlParameter("@Data", planilha.Data), new SqlParameter("@Filial", planilha.Filial), new SqlParameter("@Ano", planilha.Ano), new SqlParameter("@Caixa", planilha.Caixa), new SqlParameter("@Cte", planilha.Protocolo));
        }
